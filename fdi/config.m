...
% See also  main_simulation, fdi_glt, fdi_wglt, fdi_swglt.
    ...
    cfg.P_D_star = 0.95;                 % target detection probability (eq.80)
    cfg.N_dwell = 3;                     % consecutive-window dwell for isolation
    cfg.rho_threshold = 2.0;             % FI(k1)/FI(k2) margin threshold
    cfg.P_isol = 0.90;                   % Bayesian posterior threshold for isolation
